...
class CustomizedScrollWithScrollbar extends StatefulWidget {
  const CustomizedScrollWithScrollbar({
    Key key,
  ...
  @override
  _CustomizedScrollWithScrollbarState createState() =>
      _CustomizedScrollWithScrollbarState();
}

class _CustomizedScrollWithScrollbarState
    extends State<CustomizedScrollWithScrollbar> {
  ...
  @override
  void didUpdateWidget(CustomizedScrollWithScrollbar oldWidget) {
